...
@export var float_radius: float = 48.0
@export var center_offset: Vector2 = Vector2(0, 10)
...
@export var return_smoothing: float = 16.0
@export var max_speed: float = 850.0
@export var movement_influence: float = 0.2
